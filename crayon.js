...
(function() {
  "use strict";
  var VERY_DARK_COLORS, addColorFuncs, ansi256css, ansiStyle, backgroundCode, basics, begin, code, codes, color, crayon, cssToAnsi, end, foregroundCode, general, getColorNumber, hasColor, level, logLevels, makeStyleFunc, pkg, splitFlatten, stripAnsi, styleName, util, __doc__, _fn, _i, _len, _ref,
    __slice = [].slice,
  ...
  crayon.rainbow = function() {
    ...
    if (crayon.enabled) {
      return ((function() {
        ...
        _ref1 = util.format.apply(util, args);
        _results = [];
